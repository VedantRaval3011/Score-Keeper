    ...
    <div className="p-5">
      <div className="header d-flex justify-content-between align-items-center py-3">
        <h1 className="text-white">
          {" "}
          <b className="secondary-text">Result</b>Keeper{" "}
        </h1>
        <div>
          <h1
      ...
      {results.length > 0 ? (
        <Row gutter={[20, 20]}>
          <Col span={24}>
            <h1 className="text-large my-3">Welcome to our Result Portal </h1>
            ...
            return (
              <Col span={8}>
                ...
                >
                  ...
                  <hr />
                  <h1 className="text-small">Semester : {result.class}</h1>
                </div>
              </Col>
            );
          })}
